...
//
// net_booked_pnl is futures + options only. Market-making PL is the grid
// bot's own contribution and is reported on the bot side, from the entry log,
// so it is neither stored in this total nor deducted from it.
